...
sig = ecf2(sig_z, sig_theta, beta = 0.5)
bkg = ecf2(bkg_z, bkg_theta, beta = 0.5)
...
plt.legend()
plt.title("Two point energy function (beta = 0.5)")
plt.ylabel("Density")

plt.savefig("outputs/plots/two_point_energy_distribution_beta05.png")

ak.to_parquet(ak.Array({"e2_beta_0.5": sig}),"cache/signal_e2_beta_05_1000.parquet", compression=None)
ak.to_parquet(ak.Array({"e2_beta_0.5": bkg}),"cache/bkg_e2_beta_05_1000.parquet", compression=None)
